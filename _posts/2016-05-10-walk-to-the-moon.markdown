...
Above, you can try out my first _Walk to the Moon_ prototype for yourself. Some of the interactions aren't easy to replicate, for example the badge list scrolling, so below is a video, created in Quartz Composer using Origami, of what this interaction would look like on an actual device. 
