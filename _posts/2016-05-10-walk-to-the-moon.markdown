...
Above, you can try out my first _Walk to the Moon_ prototype for yourself. Some of the interactions aren't easy to replicate in Marvel, for example the badge list scrolling, so below is a video of what this would look like on an actual device and in the app. 
