...
<figure class="figure">
  <img src="/img/gameDayOverlay.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
  <figcaption class="figure-caption">The original overlay took major cues from the design language of Magic The Gathering</figcaption>
</figure>
